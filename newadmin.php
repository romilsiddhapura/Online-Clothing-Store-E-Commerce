        ...
        <?php
          ...
          if($new_result){
            while($obj = $new_result->fetch_object())
            {
                ...
                echo '<p style="text-align:center;"><strong>Category</strong>: '.$obj->category.'</p>';
                echo '<p style="text-align:center;"><strong>Units Available</strong>: '.$obj->qty.'</strong></p>';
                ...
                echo '<a href="update-item.php?id='.$obj->id.'" class="btn btn-info" style="font-size: 17px; width: 105px;">Edit</a> ';
                echo '<a href="delete-item.php?id='.$obj->id.'" class="btn btn-info" style="font-size: 17px; width: 105px;">Delete</a>';
